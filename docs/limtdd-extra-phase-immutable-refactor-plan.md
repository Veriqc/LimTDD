...
> **日期**: 2026-08-23（方向 2 实施完成 2026-08-26）
> **状态**: 方向 1（phase 纳入节点身份）**已实施并证伪**；方向 2 的设计方案**已实施并验证正确**，详见 [`limtdd-extra-phase-direction2-implementation.md`](./limtdd-extra-phase-direction2-implementation.md)。
