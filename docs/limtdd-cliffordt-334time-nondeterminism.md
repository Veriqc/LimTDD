...
> **日期**: 2026-08-22（更新 2026-08-23）
> **状态**: 根因已定位，**尚未修复**；方向 1（`extra_phase` 纳入节点身份）**已实施并证伪**（`dj_60` 爆炸），正确方案方向 2（拆出 pending phase）见 [`limtdd-extra-phase-immutable-refactor-plan.md`](./limtdd-extra-phase-immutable-refactor-plan.md)
